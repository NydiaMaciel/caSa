...
class TransRp extends StatefulWidget {
  Jugadores usuario;
  String token;
  TransRp({super.key, required this.usuario, required this.token});

  @override
  State<TransRp> createState() => _TransRpState();
}

class _TransRpState extends State<TransRp> {
  ...
  Future<void> fetchTransUS()async{
